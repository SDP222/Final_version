...
public class Parameters extends JPanel {
    ...
    Parameters() {
        ...
        add(staff);
        highestScore = new JLabel("Highest Score");
        highestScore.setBounds(10, 10, 180, 100);
        highestScore.setBounds(10, 350, 180, 40);
        add(highestScore);
        update();
    }
    ...
    void update() {
        ...
        //try{
    	   //score = new File("res/score.txt");
           //Scanner sc = new Scanner(score); 
           //highestScore.setText("Highest Score : " + sc.nextLine());
       //} catch (IOException e){
    //	   e.printStackTrace();
      // }
    ...
    {
    	/*try {
    	  	   	FileWriter scoreChange = new FileWriter("res/score.txt");
    	  	   	scoreChange.write(x);
    	} 
    	catch (IOException e){
     	   e.printStackTrace();
